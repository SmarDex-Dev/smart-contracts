...
export function shouldRevertAtMaxRewardLimit() {
  const nbRewardInfo: number = 28591; // 28591 OK -  28592 out of gas

  describe.skip("Max reward info limit", async function () {
