...
export function shouldBehaveLikeApplyKConstRuleOutV1(): void {
  it("with logic", async function () {
    ...
    const result = await (this.contracts.smardexLibraryTest as SmardexLibraryTestV1).applyKConstRuleOut(
      amountIn,
      reserveIn,
      reserveOut,
      fictiveReserveIn,
