...
export function shouldBehaveLikeComputeFirstTradeQtyOutV1(): void {
  it("when _fictiveReserveOut * _priceAverageIn < _fictiveReserveIn * _priceAverageOut", async function () {
    ...
    const result = await (this.contracts.smardexLibraryTest as SmardexLibraryTestV1).computeFirstTradeQtyOut(
      amountOut,
      fictiveReserveIn,
      fictiveReserveOut,
      priceAverageIn,
